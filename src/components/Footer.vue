<template>
  <footer class="max-w-5xl mx-auto px-8 py-10 text-gray-500 text-sm">
    <div class="flex gap-6 mb-6 text-xl text-white">
      <i class="fab fa-facebook-f cursor-pointer hover:text-gray-300"></i>
